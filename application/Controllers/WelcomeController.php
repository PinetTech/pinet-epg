...
class WelcomeController extends BaseController
{
	...
	public function test() {
		...
		return $this->render('welcome/index', array(
				...
				'items'=>array(
						(object)array('title'=>'nature1',
								'image'=>'http://lorempixel.com/1200/1200/nature/1'),
						(object)array('title'=>'nature2',
								'image'=>'http://lorempixel.com/1200/1200/nature/2'),
						(object)array('title'=>'nature3',
								'image'=>'http://lorempixel.com/1200/1200/nature/3'),
						(object)array('title'=>'nature4',
								'image'=>'http://lorempixel.com/1200/1200/nature/4'),
						(object)array('title'=>'nature5',
								'image'=>'http://lorempixel.com/1200/1200/nature/5'),
						(object)array('title'=>'nature6',
								'image'=>'http://lorempixel.com/1200/1200/nature/6'),
						(object)array('title'=>'nature7',
								'image'=>'http://lorempixel.com/1200/1200/nature/7'),
						(object)array('title'=>'nature8',
								'image'=>'http://lorempixel.com/1200/1200/nature/8'),
						(object)array('title'=>'nature9',
								'image'=>'http://lorempixel.com/1200/1200/nature/9')
				),
				"tab"=>array(
						"navs"=>array(
								'nav1',
				...
				"videos"=>array(
						(object)array('title'=>'movie title1', 'count'=>'152万', 'imageSrc'=>\Clips
						\static_url('application/static/img/test/01.png')),
						(object)array('title'=>'movie title2', 'count'=>'152万', 'imageSrc'=>\Clips
						\static_url('application/static/img/test/01.png')),
						(object)array('title'=>'movie title3', 'count'=>'152万', 'imageSrc'=>\Clips
						\static_url('application/static/img/test/01.png')),
						(object)array('title'=>'movie title4', 'count'=>'152万', 'imageSrc'=>\Clips
						\static_url('application/static/img/test/01.png')),
						(object)array('title'=>'movie title5', 'count'=>'152万', 'imageSrc'=>\Clips
						\static_url('application/static/img/test/01.png')),
						(object)array('title'=>'movie title6', 'count'=>'152万', 'imageSrc'=>\Clips
						\static_url('application/static/img/test/01.png'))
				)
		));
	}
